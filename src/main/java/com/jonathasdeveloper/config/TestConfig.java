...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		/*
		 * Pet p1 = new Pet(null, "Bidu", "dachshund", "canina", "macho",
		 * "preto com manchas caramelo", t2); Pet p2 = new Pet(null, "Mimoso", "SRD",
		 * "felina", "macho", "Branco acinzentado", t4); Pet p3 = new Pet(null, "Amora",
		 * "SRD", "canina", "femea", "preto e branco", t3); Pet p4 = new Pet(null,
		 * "Sheik", "SRD", "canina", "macho", "marrom", t2); Pet p5 = new Pet(null,
		 * "Maia", "SRD", "canina", "femea", "branco", t2); Pet p6 = new Pet(null,
		 * "Blue", "SRD", "felina", "femea", "branco", t3);
		 * 
		 * petRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5, p6));
		 * 
